...
class Gun:
    ...
    def draw(self):
        ...
        polygon(self.screen, self.color, [(self.x + self.dlin / 2, self.y), (self.x - self.dlin / 2, self.y), (self.x - self.dlin /2, self.y + self.shir), (self.x + self.dlin / 2, self.y + self.shir), (self.x + self.dlin / 2, self.y)])
        circle (self.screen, self.color, (self.x, self.y), self.dlin / 4) 
